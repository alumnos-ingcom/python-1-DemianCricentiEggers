...
centigrados = float(input("ingrese valor en grados centigrados para realizar la operacion"))
fahrenheit = convertir_a_fahrenheit(centigrados)
print("son", fahrenheit," grados fahrenheit")

fahrenheit = float(input("ingrese valor en grados fahrenheit para realizar la operacion"))
